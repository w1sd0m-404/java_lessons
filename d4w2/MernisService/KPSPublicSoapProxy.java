...
public class KPSPublicSoapProxy implements MernisService.KPSPublicSoap {
  private String _endpoint = null;
  private MernisService.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new MernisService.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public MernisService.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
